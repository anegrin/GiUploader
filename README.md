...
1. Select a firmware variant.
2. Put the STM32F072 board in DFU mode and connect it over USB.
3. Choose **Upload** or **Erase and Upload**.
4. Wait while GiUploader erases, writes, and finalizes the firmware.
